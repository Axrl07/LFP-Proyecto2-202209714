...
class Ventana():
    def __init__(self, root=tk.Tk()):
        ...
        self.boton_borrar_entrada = tk.Button(self.root,
            text="Borrar entrada",
        ...
        self.boto_borrar_salida = tk.Button(self.root,
            text="Borrar salida",
            command=self.borrar
        ).grid(
            row=1,
